...
var fetch_path = "https://rahul-ldn.github.io/prindex/prindex.infographics.html?cc="+cc;
var save_path = "infographics/prindex.infographics."+cc+".pdf";
...
var cc =  country_name_map[parseInt(process.argv[2])].Code;
var cn = country_name_map[parseInt(process.argv[2])].Name;
var fetch_path = "https://rahul-ldn.github.io/prindex/prindex.infographics.html?cc="+cc;
var save_path = "infographics/prindex.infographics."+cc+".pdf";  
    sleep(5000);
//    console.log("Moving to "+cc);  
  console.log ("saving "+cn+" from "+fetch_path+" to "+save_path);

(async () => {
    const browser = await puppeteer.launch({
        headless: true
    });
  //  console.log("Browser launched for "+cc);
    const page = await browser.newPage();



    await page.goto(fetch_path, {
